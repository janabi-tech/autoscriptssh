...
restart_service() {
    ...
    if [ "$service_name" == "all" ]; then
        ...
        local services=(janabitech-ws janabitech-dnstt janabitech-monitor janabitech-udp-custom janabitech-xray stunnel4 dropbear danted ssh sshd)
    ...
    case "$service_name" in
        dropbear|stunnel4|janabitech-ws|janabitech-dnstt|janabitech-monitor|janabitech-xray|danted|janabitech-udp-custom|ssh|sshd)
